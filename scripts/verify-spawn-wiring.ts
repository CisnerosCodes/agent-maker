...
async function main(): Promise<void> {
  ...
  const legitRoles: PlannedRole[] = [
    ...
    // (C15: research is broker-ingest — no issued credential; apify removed)
    role({ role: "research", name: "research-ok", objective: "find products", tools: ["web-fetch"], credentials: [], policyTemplate: "worker-research.yaml" }),
